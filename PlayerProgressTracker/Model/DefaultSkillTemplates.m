    ...
    if (!_agility){
        ...
        skillTemplate = [self newSkillTemplateWithUniqName:agilityName
                                         ...
                                         withRulesExamples:@"d6 Agility checks:\n- Modifier 0. Move on narrow surface or uneven ground without falling at half speed. Running Jump with distance equal to the half of your movement. Running distance must be more or equal to jumping distance.\n- Modifier -2. Jump from a place with distance equal to the half of your movement.\n- Modifier -4. Running Jump with distance equal to your movement. Running distance must be more or equal to jumping distance.\n- Modifier -6. Move(at full speed)/Fight on narrow surface or uneven ground without falling.\n- Modifier -8. Jump from a place with distance equal to your movement.\n\nd6 Agility check. Jumping from a height and trying land on feet will be check against double the height in meters. On success character get damage equal to double the height but with Strength 0. On failure Strength of the hit increases to amount of damage and you'll need to get up.\n- Modifier +4. Water-like liquid.\n- Modifier +2. Soft Ground: fresh snow, thick dust, wet mud.\n- Modifier 0. Firm Ground: Most normal outdoor surfaces (such as lawns, fields, woods, and the like) or exceptionally soft or dirty indoor surfaces (thick rugs and very dirty or dusty floors).\n- Modifier -2.  Hard Ground: Bare rock or an indoor floor."
                                           withDescription:@"Describe a skill and grace in physical movement. Keeping balance while traversing narrow or treacherous surfaces. You can also dive, flip, jump, and roll, avoiding attacks and confusing your opponents."
                                             withSkillIcon:nil
                                        withBasicXpBarrier:defaultPhsAndMnsBasicBarrier
                                      withSkillProgression:defaultPhsAndMnsProgression
                                  withBasicSkillGrowthGoes:defaultPhsAndMnsGrowhtGoes
...
-(SkillTemplate *)control{
    if (!_control){
        ...
        skillTemplate = [self newSkillTemplateWithUniqName:disciplineName
                                                 withRules:nil
                                         withRulesExamples:nil
                                           withDescription:@"Resist charm, resist guile, resist intimidation, resist fear, resist terror, resist torture. This skill is used to resist the startling effects of surprising events, show resolve in the face of danger, and maintain composure when confronted by supernatural or terrify- ing situations. Discipline is also the ability to maintain one’s state of mind and resist the rigours of stress or attempts to manipulate one’s thoughts or feelings."
                                             withSkillIcon:nil
    ...
    if (!_perception){
        ...
        skillTemplate = [self newSkillTemplateWithUniqName:perceptionName
                                         ...
                                         withRulesExamples:@"d6 Perception checks:\n- Modifier +3/+10. Shining item. With range dim to extreme bright.\n- Modifier -2/+5. Size of the item with range of a coin to a man-size object. +5 for every point of bulk creature possess.\n- Modifier -6/+4. Color of subject. With range of the ideal camouflage to contrasting bright color. Characters usually will pick clothes of neutral colors, like grey, brown or black avoiding any penalties, however NPC might be wearing fashion or ritual dresses, which might be more easy to pick. Penalties for the check would make any natural or artificial camouflages. If creature has more then 1 point of bulk, this multiplied by the creature's bulk.\n- Modifier 0. Normal well-lit place.\n- Modifier -3. Poorly-lit place.\n- Modifier -6. Dark place."
                                           withDescription:@"Eavesdropping, tracking, keen vision, minute details Using your senses to perceive your surroundings. It can also be used to spot traps, pitfalls, and other physical dangers. Perception opposes other characters’ attempts at Stealth, or to otherwise avoid detection.."
                                             withSkillIcon:nil
                                        withBasicXpBarrier:mentalSkillHightBasicBarrier
                                      withSkillProgression:mentalSkillHightProgression
                                  withBasicSkillGrowthGoes:defaultPhsAndMnsGrowhtGoes
...
-(SkillTemplate *)senseMotive{
    if (!_senseMotive){
        ...
        skillTemplate = [self newSkillTemplateWithUniqName:senseMotiveName
                                         ...
                                         withRulesExamples:nil
                                           withDescription:@"This skill is opposed to enemy's Bluff. You usually don't make a roll instead enemy get penalties to his Bluff against you. Sense Motive generally takes at least 1 minute, and you could spend a whole evening trying to get a sense of the people around you."
                                             withSkillIcon:nil
                                        withBasicXpBarrier:defaultAdvBasicBarrierLow
                                      withSkillProgression:defaultAdvProgression
                                  withBasicSkillGrowthGoes:defaultAdvGrowhtGoesLow
...
-(SkillTemplate *)survival{
    if (!_survival){
        ...
        skillTemplate = [self newSkillTemplateWithUniqName:survivalName
                                         ...
                                         withRulesExamples:@""
                                           withDescription:@"You are skilled at surviving in the wild and at navigating in the wilderness. You also excel at following trails and tracks left by others."
                                             withSkillIcon:nil
                                        withBasicXpBarrier:veryLowBasicBarrier
                                      withSkillProgression:veryLowProgression
                                  withBasicSkillGrowthGoes:defaultAdvGrowhtGoesLow
    ...
    if (!_heal){
        ...
        skillTemplate = [self newSkillTemplateWithUniqName:healName
                                         ...
                                         withRulesExamples:@"d8 check. Treat Poison. Treat Disease. Treat Injuries. Long-Term Care..."
                                           withDescription:@"Providing first aid, treating a wound, or treating poison. Treating a disease or tending a creature wounded. Treating deadly wounds takes 1 hour of work. Providing long-term care requires 8 hours of light activity."
                                             withSkillIcon:nil
                                        withBasicXpBarrier:veryLowBasicBarrier
                                      withSkillProgression:veryLowProgression
                                  withBasicSkillGrowthGoes:defaultAdvGrowhtGoesLow
...
-(SkillTemplate *)bow{
    if (!_bow){
        ...
        skillTemplate = [self newSkillTemplateWithUniqName:bowName
                                                 withRules:nil
                                         withRulesExamples:nil
                                           withDescription:@"Covers the basic use, care and maintenance of short and long bows."
                                             withSkillIcon:nil
...
-(SkillTemplate *)firearm{
    if (!_firearm){
        ...
        skillTemplate = [self newSkillTemplateWithUniqName:blackpowderName
                                                 withRules:nil
                                         withRulesExamples:nil
                                           withDescription:@"Covers the basic use, care and maintenance of blunderbusses, handguns, Hochland long rifles, pistols, repeater handguns and repeater pistols, crossbows, crossbow pistols and repeater crossbows."
                                             withSkillIcon:nil
...
-(SkillTemplate *)thrown{
    if (!_thrown){
        ...
        skillTemplate = [self newSkillTemplateWithUniqName:thrownName
                                                 withRules:nil
                                         withRulesExamples:nil
                                           withDescription:@"Covers the basic use, care and maintenance of javelins, lasso, nets, spear, throwing axes/hammers/daggers/stars, whips, slings and staff slings."
                                             withSkillIcon:nil
                                        withBasicXpBarrier:defaultRangeWeaponBasicBarrier
                                      withSkillProgression:defaultRangeWeaponProgression
                                  withBasicSkillGrowthGoes:defaultRangeWeaponGrowhtGoes
